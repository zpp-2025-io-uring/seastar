...
def _assert_io_uring_setup_call(
    ...
    print(f"io_uring_setup call parameters: {setup_call['params']}")
...
def _filter_out_syscalls_for_main_shard(
    ...
    SETUP_CALLS_PER_AVAILABLE_CALL = 3  # io_uring and 2x asymmetric_io_uring (base and attached)
    IO_URING_REGISTER_CALLS_PER_AVAILABLE_CALLS_COUNT = (
        4 # probe for io_uring, 2x probe and wq_affinity for asymmetric_io_uring
    )
